        ...
        <div className={styles.container} style={{ alignItems: 'flex-start', paddingTop: '4rem' }}>
            <div className={styles.card} style={{ maxWidth: '900px', margin: '0 auto', textAlign: 'left' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', color: '#ccc', lineHeight: '1.8' }}>
                    <section>
                        <p>Welcome to Al-Urbans. This website is operated by Al-Urbans LLC. Throughout the site, the terms “we”, “us” and “our” refer to Al-Urbans LLC. Al-Urbans offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>All content included on this site, such as text, graphics, logos, images, audio clips, digital downloads, and structural code, is the property of Al-Urbans LLC or its content suppliers and protected by international copyright laws. The compilation of all content on this site is the exclusive property of Al-Urbans LLC.</p>
                    </section>
