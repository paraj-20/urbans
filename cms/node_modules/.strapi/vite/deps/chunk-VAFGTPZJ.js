import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-OPUHS3IZ.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-GV3RDC2U.js";
import {
  LimitsModal
} from "./chunk-BYCZFEPK.js";
import {
...
} from "./chunk-JHIBONRR.js";
import {
  useTypedSelector
} from "./chunk-BZCHUYBT.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-EKPRBRFT.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-JVVL3BZQ.js";
import {
  index
} from "./chunk-R5A4EDO3.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-BSND3KDQ.js";
import {
  useConfig
} from "./chunk-LAK7CZPJ.js";
import {
  Primitive,
  abortUpload,
  cancelUpload,
...
import {
  useDocumentActions
} from "./chunk-2Z72ENL7.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-OI3V4DTW.js";
import {
  renderAdmin
...
import {
  useLicenseLimits
} from "./chunk-OZLEQKLW.js";
import {
  Table,
  useTable
} from "./chunk-O76Y7MLX.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-XZ3YMIAF.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-Z5DCHTSM.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-X7SBQ4TJ.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-7GE4ATWF.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-IDMTKWVH.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-OVPTG2KT.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-LIHOLTAA.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-QGTCU4YD.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-KVIBNDMC.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-PPV45N26.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-CY7DN2FS.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-7X3ECB3S.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-QUB5SFOM.js");
          return {
...
//# sourceMappingURL=chunk-VAFGTPZJ.js.map
